...
"France" or country = "USA";

select * from customers where country
in("USA","France","Australia");
...
select * from customers where creditlimit > 50000 and country =
"Australia" order by creditlimit desc;
...
creditlimit desc limit 1 offset 2;